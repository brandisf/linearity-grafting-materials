...
__all__ = ['mnist_2_32_graft', 'mnist_1_64_graft', 'mnist_8_200_graft', 'mnist_conv_big_graft', 'svhn_conv_big_graft',
           'cifar_cnn_b_graft', 'cifar_cnn_17m_graft', 'cifar_conv_big_graft', 'cifar_resnet4b_graft']
...
class LinearMaskedRelu(nn.Module):
    ...
    def __init__(self, size, value=1, bias=0):
        super().__init__()
...
class mnist_2_32_graft(nn.Module):

    def __init__(self, v=1.0, b=0.0):
        super(mnist_2_32_graft, self).__init__()

        self.layer0 = Flatten()
        self.layer1 = nn.Linear(784, 32)
        self.linear_masked_relu2 = LinearMaskedRelu(size=(32), value=v, bias=b)
        self.layer3 = nn.Linear(32, 32)
        self.linear_masked_relu4 = LinearMaskedRelu(size=(32), value=v, bias=b)
...
class mnist_1_64_graft(nn.Module):

    def __init__(self, v=1.0, b=0.0):
        super(mnist_1_64_graft, self).__init__()

        self.layer0 = Flatten()
        self.layer1 = nn.Linear(784, 64)
        self.linear_masked_relu2 = LinearMaskedRelu(size=(64), value=v, bias=b)
