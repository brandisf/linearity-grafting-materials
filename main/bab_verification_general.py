...
def bab(unwrapped_model, data, target, y, eps=None, data_ub=None, data_lb=None, lower_bounds=None, upper_bounds=None, reference_slopes=None, attack_images=None):
    ...
    min_lb, min_ub, glb_record, nb_states, unstable_mask = relu_bab_parallel(model, domain, x, refined_lower_bounds=lower_bounds,
    ...
    return min_lb, min_ub, nb_states, glb_record, unstable_mask
