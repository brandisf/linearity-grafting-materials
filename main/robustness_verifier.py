...
def main():
    ...
    if arguments.Config["general"]["mode"] == "clean-acc":
        ...
        #get_test_acc(model_ori, input_shape = (1, 28, 28), batch_size=arguments.Config["solver"]["beta-crown"]["batch_size"])
        return
    ...
    base_path = 'VERIFY/VERIFY[{}-{}]_start={}_end={}_iter={}_b={}_timeout={}_branching={}-{}-{}_lra-init={}_lra={}_lrb={}_PGD={}/'. \
    ...
    save_path = base_path + "verified_ret.npy"
    index_results_path = base_path + 'index_results.pkl'
    instability_masks_path = base_path +'instability_masks.pkl'
    adv_example_path = base_path + "adv_examples.pkl"
    ...
    for new_idx, imag_idx in enumerate(bnb_ids):
        ...
        if arguments.Config["attack"]["pgd_order"] == "before":
            ...
            attack_ret, attack_images, attack_margin, attack_image = pgd_attack(**attack_args)
            ...
            if attack_ret:
                ...
                if arguments.Config["general"]["save_adv_example"]:
                        ...
                        obj = {"ID":imag_idx, "y":y, "attack_label":attack_label, "x": x.squeeze(), "attack_image":attack_image.squeeze()}
                        adv_example_dict[new_idx] = obj
                        with open(adv_example_path, 'wb') as handle:
                            pickle.dump(adv_example_dict, handle, protocol=pickle.HIGHEST_PROTOCOL)
                continue
                ...
                if arguments.Config["general"]["enable_incomplete_verification"]:
                    ...
                    if init_global_lb[0].min().item() - arguments.Config["bab"]["decision_thresh"] <= -100.:
                        ...
                        if arguments.Config["bab"]["timeout"] < 0:
                            ...
                            l, u, nodes, glb_record, unstable_mask = bab(model_ori, x, pidx, y=y, eps=perturb_eps, data_ub=data_max, data_lb=data_min,
                    ...
                    l, u, nodes, glb_record, unstable_mask = bab(model_ori, x, pidx, y=y, eps=perturb_eps,
        ...
        mask_dict[new_idx] = (imag_idx, unstable_mask)
        with open(instability_masks_path, 'wb') as handle:
        ...
        with open(index_results_path, 'wb') as handle:
            pickle.dump(OrderedDict([('skipped_examples' , skipped_examples), 
                ('attack_successes' , attack_success), 
                ('verification_success', verified_success_list),
                ('verification_failure', verified_failed)]), handle, protocol=pickle.HIGHEST_PROTOCOL)
    ...
    print("Saved results under \'"+base_path+"\'")
